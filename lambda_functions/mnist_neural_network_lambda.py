...
SMALL_FILE = 'mnist_C_small.npy'
NORMAL_FILE = 'mnist_C.npy'
...
def lambda_handler(event, context):
    ...
    print("weight of B: ", weight_B[0])

    # Load test data
    download_path = '/tmp/' + SMALL_FILE
    s3_client.download_file(BUCKET_NAME, SMALL_FILE, download_path)
    ...
    # try different combination of weight_A and weight_B
    results = {}
